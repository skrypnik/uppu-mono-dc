...
namespace Enercom
{
    ...
    */
    class LoVoltageInfo final : public QObject
    {
        Q_OBJECT
        ...
        /**
         * Amplifier ratio metaobject property
         */
        Q_PROPERTY( QVariant amplifierRatio READ amplifierRatio NOTIFY changed )
        ...
        /**
         * Amplifier attenuator metaobject property
         */
        Q_PROPERTY( QVariant attenuator READ attenuator NOTIFY changed )
    ...
    public:
        ...
        */
        using Ptr = std::shared_ptr<LoVoltageInfo>;

    public:
        /**
         * Constructs current device high voltage params object
         */
        explicit LoVoltageInfo(QObject* parent = nullptr);
    ...
    private:
       ...
       [[nodiscard]] QVariant regulatorVoltageMin() const;
        ...
        /**
         * Amplifier ratio metaobject getter
         */
        [[nodiscard]] QVariant amplifierRatio() const;
        ...
        /**
         * Amplifier attenuator metaobject getter
         */
        [[nodiscard]] QVariant attenuator() const;
